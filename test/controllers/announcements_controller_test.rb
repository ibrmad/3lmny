...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { content: @announcement.content, date: @announcement.date, image_data: @announcement.image_data, title: @announcement.title } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { content: @announcement.content, date: @announcement.date, image_data: @announcement.image_data, title: @announcement.title } }
